...
export class Util {
    ...
    */
    ...
    /**'
     * Convert hexa color to RGB with opacity
    */
    static hexToRGB(h, opacity=1) {
        let r = "0", g = "0", b = "0";
    ...
    */
    static updateMainColor(main_color) {
        ...
        let backgroundColor = Util.hexToRGB(main_color, 0.1);
        // Util.updateElementAttributes("html", "background-color", main_color);
        Util.updateElementAttributes("html", "background-color", backgroundColor);
    }
