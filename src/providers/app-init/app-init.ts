    ...
    private messageListener(e) {
        ...
        if ( e.origin === this.urlParams.get('origin') ) {
            try {
                ...
                if (Object.keys(data.attached_info).length) {
                    if (Object.keys(this.header.attached_info).length) {
                        this.header.attached_info = Object.assign(this.header.attached_inf, data.attached_info)
                    }   
                    else {
